...
const Partners: React.FC = () => {
  ...
  //  { href: "https://sequretek.com/", src: "images/sequretek_logo.jpg", alt: "Sequretek" },
    // Woxsen moved to Academic Partners
  ...
  //  { href: "#", src: "images/threatcop_logo.png", alt: "ThreatCop" },
    ...
    { href: "https://www.e2enetworks.com/", src: "images/E2E.png", alt: "E2E Networks" },
    { href: "https://www.linkedin.com/company/intellirms/about/", src: "images/intellirms.png", alt: "intellirms" }
  ...
  return (
    <section className="w-full bg-white py-16">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        {/* Partner Logos Grid */}
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4 gap-4 sm:gap-2">
          <AnimatePresence>
