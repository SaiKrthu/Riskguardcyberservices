  ...
  return (
    ...
    >
      ...
      <div className="flex items-center mb-4">
        {SomeIcon && (
          <SomeIcon className="w-8 h-8 text-orange-500 mr-3" />
        )}
      ...
      <Link
        ...
        className="block w-full bg-orange-500 text-white py-2 px-4 rounded-lg hover:bg-orange-600 transition-colors text-center"
      >
        Explore Now
      </Link>
    </motion.div>
